...
$(document).ready(function(){
    ...
    $("#translation_form").on("submit", function(event) {
        ...
        // Image enhance jquery code close //
            ...
            $(document).on("submit", "#video_enhance_form", function (event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let videoElement = document.getElementById("enhancedVideo");
                        let sourceElement = document.getElementById("videoSource");
                    
                        sourceElement.src = response.file_url;  // Set video source
            ...
            // crowd image jquery code open //





            $(document).on("submit", "#image_crowd_form", function (event) {
                $("#image_crowd_submit").prop('disabled', true);
                console.log("Form submitted via event delegation");
                event.preventDefault();
                // Rest of your AJAX logic here...
                ...
                var formData = new FormData();
                var fileInput = $("#image_crowd_file")[0].files[0];
                console.log("fileinput", fileInput);
                ...
                formData.append("crowd_detection_files", fileInput);
                formData.append('type', 'image_file')
                console.log("Sending request...");
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#density_map").show();
                        $("#density_count").show();
                        $("#density_map_img").attr("src", response.Density_map_name).show();
                        $("#density_count_img").attr("src", response.Density_count_name).show();
            ...
            // crowd image jquery code close  //

            
            // crowd video jquery code open //
            ...
            $(document).on("submit", "#video_crowd_form", function (event) {
                $("#video_crowd_submit").prop('disabled', true);
                console.log("Form submitted via event delegation");
                event.preventDefault();
                // Rest of your AJAX logic here...
                ...
                var formData = new FormData();
                var fileInput = $("#video_crowd_file")[0].files[0];
                console.log("fileinput", fileInput);
