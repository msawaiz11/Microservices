...
with open(csv_file, mode='w', newline='') as file:
    ...
    writer.writerow(["Date", "Timestamp", "Class", "Track_ID", "Confidence", "IoU", "Area_Growth_Rate", "X1", "Y1", "X2", "Y2"])
                    ...
                    if size_variation / avg_size < 0.05:
                        ...
                        if save_detection:
                            ...
                            save_detection_info(csv_file, [
                                ...
                                current_iou, area_growth_rate, x1, y1, x2, y2
                            ])
